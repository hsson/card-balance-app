...
public abstract class BackendService<T> extends IntentService {
    ...
    protected String readResponse(HttpURLConnection connection) throws BackendFetchException {
    ...
    protected HttpURLConnection prepareConnection(String endpoint, String variable) throws IOException {
